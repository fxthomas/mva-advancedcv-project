 ...
 */
PyDoc_STRVAR (Py_dp_doc, "dp (left, right, [energy], [backward=False], [nd=10], [axis=1], [P1=10], [P2f=100], [P3=0.4], [T=20])\n\
\n\
...
PyDoc_STRVAR (Py_data_energy_doc, "data_energy (left, right, [nd=10], [axis=0])\n\
\n\
